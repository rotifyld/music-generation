...
def random_midis(decoder: Callable[[torch.Tensor], torch.Tensor], epoch, data_length, number=10,
    ...
    for i, f in enumerate(fs_decoded):
        for j, th in enumerate(thresholds):
            ...
            song_to_midi(song, 'export/midi/autoencoder_batch/d{}_e{}_n{}_th{}'
                         .format(data_length, epoch, i * len(thresholds) + j, th))
